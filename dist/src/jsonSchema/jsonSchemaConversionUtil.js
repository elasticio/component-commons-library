...
exports.convertDotNetTypeToJsonSchemaType = exports.makeSchemaInline = exports.convertJsonSchemaToEioSchema = void 0;
function convertJsonSchemaToEioSchema(keyToReturn, completeSchemaOriginal) {
...
exports.convertJsonSchemaToEioSchema = convertJsonSchemaToEioSchema;
function makeSchemaInline(json, availableSchemas) {
...
exports.makeSchemaInline = makeSchemaInline;
function convertDotNetTypeToJsonSchemaType(dotNetType) {
    switch (dotNetType) {
        case 'System.String':
...
exports.convertDotNetTypeToJsonSchemaType = convertDotNetTypeToJsonSchemaType;
