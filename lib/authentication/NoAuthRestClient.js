...
class NoAuthRestClient {
    ...
    async makeRequest(options) {
        ...
        const urlToCall = urlIsSegment
            ? `${remove_trailing_slash_1.default(this.cfg.resourceServerUrl.trim())}/${remove_leading_slash_1.default(url.trim())}` // Trim trailing or leading '/'
            : url.trim();
...
//# sourceMappingURL=NoAuthRestClient.js.map